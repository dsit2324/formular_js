...
btnCalc.addEventListener('click', function() {
    ...
    output.innerHTML = `Hello ${firstname.value}, your path value based on speed and time is ${path}.`
    if (posledniVysledek.length > 1){
        outputArray.innerHTML = `Your previous answer was ${posledniVysledek[posledniVysledek.length - 2]}.`
    } else {
